...
-- z3 diagnostic maps
vim.keymap.set('n', '<leader>qn', vim.diagnostic.goto_next, { desc = '[N]ext Diagnostic' })
vim.keymap.set('n', '<leader>qp', vim.diagnostic.goto_prev, { desc = '[P]revious Diagnostic' })
...
--
-- z3 modified from CTRL to space
